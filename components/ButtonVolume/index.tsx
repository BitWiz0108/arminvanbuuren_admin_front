...
const ButtonVolume = ({ volume, setVolume, size }: Props) => {
    ...
    <button
      className={twJoin(
        ...
        size == "small"
          ...
          : size == "big"
            ? "w-[55px] h-[55px] md:w-[65px] md:h-[65px]"
            : "w-[75px] h-[75px] md:w-[85px] md:h-[85px]",
        "bg-[#363635]"
      )}
    ...
    >
      ...
      >
        {volume == 0 ? (
          ...
          <VolumeLow width={24} height={24} />
        ) : (
          <VolumeMax width={24} height={24} />
        )}
      </span>
